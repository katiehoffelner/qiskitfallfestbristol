  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'No, our sessions are designed to provide value to everyone, regardless of prior knowledge. \
          However, if you want to get more out of the event, we would recommend checking out our Resources page to learn more.',
      },
      {
        question: 'I won\'t be available to attend all the sessions, is that okay?',
        answer:
          'Attendance at all four sessions is recommended but not compulsory. \
          Please register even if you only plan on attending one session. \
          For those who can\'t attend the coding workshop but would still like to try out the exercises, \
          our team will be available on our Discord server to help out.',
      },
      {
        question: 'Do I need to prepare anything before the event?',
        answer:
          'Our coding workshop will make use of the Qiskit library on Python, \
